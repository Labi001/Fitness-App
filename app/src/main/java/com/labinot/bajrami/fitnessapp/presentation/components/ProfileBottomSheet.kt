        ...
        ModalBottomSheet(
            ...
            Column(
                ...
                ProfilePicPlaceholder(
                    ...
                    borderWidth = 2.dp,
                    profilePictureUrl =  if (user == null || user.isAnonymous) null else user.profilePictureUrl,
                    padding = 5.dp
                )
                Spacer(modifier = Modifier.height(10.dp))
                Text(
                ...
                Text(
                    text = if (user == null || user.isAnonymous) "anonymous@Fitness.io" else user.email ,
